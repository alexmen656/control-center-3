    ...
    <div class="table-container">
      <table>
        <tbody>
          ...
          <tr v-for="(tr, rowIndex) in filteredAndSortedData" :key="tr">
            <td
              v-for="(td, colIndex) in tr"
              :key="colIndex"
              @dblclick="enableEditing(rowIndex, colIndex)"
            >
...
export default defineComponent({
  ...
  methods: {
    ...
    enableEditing(rowIndex, colIndex) {
      this.editingCell = { rowIndex, colIndex };
      this.editValue = this.filteredAndSortedData[rowIndex][colIndex];
    },
