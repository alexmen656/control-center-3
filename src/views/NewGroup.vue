        ...
        <ion-list>
          ...
          <ion-item>
            ...
            <ion-select multiple v-model="selectedParticipants">
              <ion-select-option v-for="participant in participants" :key="participant.id" :value="participant.id">
                {{ participant.name }}
              </ion-select-option>
            </ion-select>
          </ion-item>
  ...
  export default {
    ...
    methods: {
      ...
      createGroup() {
        ...
        axios.post('https://alex.polan.sk/control-center/groups.php', formData)
          .then(response => {
            if (response.data.success) {
              ...
              axios.post('https://alex.polan.sk/control-center/groups.php', groupData)
                .then(response => {
