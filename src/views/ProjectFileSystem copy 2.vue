        ...
        <div class="navigation-bar">
             ...
             <div class="folder-creation-bar">
                 <input 
                  ...
                  />
                 <button class="action-btn icon-only secondary" @click="createFolder" :disabled="!newFolderName.trim()" title="Create Folder">
        ...
        <div class="data-card">
          <div class="card-header">
            ...
            <div class="header-right">
                ...
                <div class="view-toggle">
                  <button class="action-btn icon-only" :class="{ 'active': viewMode === 'grid' }" @click="viewMode = 'grid'" title="Grid View">
                    <ion-icon name="grid-outline"></ion-icon>
                  </button>
                  <button class="action-btn icon-only" :class="{ 'active': viewMode === 'list' }" @click="viewMode = 'list'" title="List View">
                    <ion-icon name="list-outline"></ion-icon>
                  </button>
                </div>
            </div>
                   ...
                   <div v-for="item in displayedItems" :key="item.id" 
                    ...
                    >
                       ...
                       <div class="table-cell" style="flex: 1;">
                           <span v-if="item.type === 'folder'" class="cell-content text-secondary">{{ item.children ? item.children.length : 0 }} items</span>
                           <span v-else class="cell-content text-secondary">{{ getFileExtension(item.name).toUpperCase() }}</span>
                       </div>
...
/* Data Card & Header matching ManageUsers */
.data-card {
