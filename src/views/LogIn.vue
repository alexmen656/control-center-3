                ...
                <ion-list>
                  <ion-item>
                    ...
                    <ion-input
                      ...
                      autocapitalize="off"
                      :value="username"
                      @ionInput="username = $event.target.value; showUsernameError = false; usernameError = ''"
                      required
                  ...
                  <ion-text color="danger">
                    <p v-show="showUsernameError" padding-left>{{usernameError}}</p>
                  </ion-text>
                  ...
                  <ion-item>
                    ...
                    <ion-input
                      ...
                      type="password"
                      :value="password"
                      @ionInput="password = $event.target.value; showPasswordError = false; passwordError = ''"
                      required
                      placeholder="****"
                    ></ion-input>
                  </ion-item>
    ...
    async onLogin() {
      if(this.username == ""){
        ...
        const options = {
          ...
          url: 'https://alex.polan.sk/control-center/login.php',
        };
        await axios(options)
          .then(
            res => {
              ...
              if(res.data.token){
                ...
                if(res.data.command == "verify-ip"){
                  localStorage.setItem("verification_email", res.data.verification_email)
                  localStorage.setItem("verification_name", res.data.verification_name)
                  localStorage.setItem("verification_token", res.data.verification_token)
