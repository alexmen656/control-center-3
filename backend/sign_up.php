...
if(isset($_POST['first_name']) && isset($_POST['email_adress']) && isset($_POST['password'])){
    ...
    if(query("INSERT INTO control_center_users VALUES(0, 'avatar', '$first_name', '$last_name', '$email_adress', '$password', '$token', 'pending_verification')")){
