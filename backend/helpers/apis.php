...
class ApisHelper
{
    public static function generateApiKey($projectID = null)
    {
        $suffix = $projectID ? '_' . $projectID : '_' . time();
        return 'cms_' . bin2hex(random_bytes(16)) . $suffix;
    }

    public static function formatEndpointData($endpoint)
    {
        return [
            'id' => $endpoint['id'],
            'name' => $endpoint['name'],
    ...
    public static function formatAvailableApiData($api)
    {
        return [
            'id' => $api['id'],
            'name' => $api['name'],
    ...
    public static function formatProjectSubscriptionData($sub)
    {
        return [
    ...
    public static function formatUsageData($day)
    {
        return [
            'date' => $day['date'],
    ...
    public static function calculateUsageStats($subscriptionId)
    {
        if (!$subscriptionId) {
            return [
                'totalRequests' => 0,
    ...
    public static function logApiCall($subscriptionId, array $data)
    {
    ...
    public static function getApiCallLogs($subscriptionId, array $filters = [])
    {
        $subscriptionId = intval($subscriptionId);
    ...
    public static function formatCallLogEntry($row)
    {
        return [
            'id' => intval($row['id']),
    ...
    public static function copyAPISDKToProject($projectName, $apiSlug, $userID)
    {
    ...
    public static function removeAPISDKFromProject($projectName, $apiSlug, $userID)
    {
        $projectDir = __DIR__ . "/../../data/projects/" . $userID . "/" . $projectName;
        $apisDir = $projectDir . '/.monaco_apis';
        $targetFile = $apisDir . '/' . $apiSlug . 'SDK.js';
    ...
    public static function updateAPIBundle($projectName, $userID)
    {
        $projectDir = __DIR__ . "/../../data/projects/" . $userID . "/" . $projectName;
        $apisDir = $projectDir . '/.monaco_apis';
    ...
    public static function formatCodespaceApiData($api)
    {
        return [
    ...
    public static function calculateCodespaceUsageStats($activationId)
    {
        if (!$activationId) {
            return [
                'totalRequests' => 0,
    ...
    public static function copyAPISDKToCodespace($projectName, $codespaceSlug, $apiSlug, $userID)
    {
    ...
    public static function removeAPISDKFromCodespace($projectName, $codespaceSlug, $apiSlug, $userID)
    {
        $codespaceDir = __DIR__ . "/../../data/projects/" . $userID . "/" . $projectName . "/" . $codespaceSlug;
        $apisDir = $codespaceDir . '/.monaco_apis';
        $targetFile = $apisDir . '/' . $apiSlug . 'SDK.js';
    ...
    public static function updateCodespaceAPIBundle($projectName, $codespaceSlug, $userID)
    {
        $codespaceDir = __DIR__ . "/../../data/projects/" . $userID . "/" . $projectName . "/" . $codespaceSlug;
        $apisDir = $codespaceDir . '/.monaco_apis';
...
{
    return ApisHelper::generateApiKey($projectID);
}

function formatEndpointData($endpoint)
{
    return ApisHelper::formatEndpointData($endpoint);
}

function formatAvailableApiData($api)
{
    return ApisHelper::formatAvailableApiData($api);
}

function formatProjectSubscriptionData($sub)
{
    return ApisHelper::formatProjectSubscriptionData($sub);
}

function formatUsageData($day)
{
    return ApisHelper::formatUsageData($day);
}

function calculateUsageStats($subscriptionId)
{
    return ApisHelper::calculateUsageStats($subscriptionId);
}

function logApiCall($subscriptionId, array $data)
{
    return ApisHelper::logApiCall($subscriptionId, $data);
}

function getApiCallLogs($subscriptionId, array $filters = [])
{
    return ApisHelper::getApiCallLogs($subscriptionId, $filters);
}

function formatCallLogEntry($row)
{
    return ApisHelper::formatCallLogEntry($row);
}

function copyAPISDKToProject($projectName, $apiSlug, $userID)
{
    return ApisHelper::copyAPISDKToProject($projectName, $apiSlug, $userID);
}

function removeAPISDKFromProject($projectName, $apiSlug, $userID)
{
    return ApisHelper::removeAPISDKFromProject($projectName, $apiSlug, $userID);
}

function updateAPIBundle($projectName, $userID)
{
    return ApisHelper::updateAPIBundle($projectName, $userID);
}

function formatCodespaceApiData($api)
{
    return ApisHelper::formatCodespaceApiData($api);
}

function calculateCodespaceUsageStats($activationId)
{
    return ApisHelper::calculateCodespaceUsageStats($activationId);
}

function copyAPISDKToCodespace($projectName, $codespaceSlug, $apiSlug, $userID)
{
    return ApisHelper::copyAPISDKToCodespace($projectName, $codespaceSlug, $apiSlug, $userID);
}

function removeAPISDKFromCodespace($projectName, $codespaceSlug, $apiSlug, $userID)
{
    return ApisHelper::removeAPISDKFromCodespace($projectName, $codespaceSlug, $apiSlug, $userID);
}

function updateCodespaceAPIBundle($projectName, $codespaceSlug, $userID)
{
    return ApisHelper::updateCodespaceAPIBundle($projectName, $codespaceSlug, $userID);
}
