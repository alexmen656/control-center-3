          ...
          <div v-if="secondButtonText">
            <div v-if="disabled && disabledWhichButton === 'secondButton'">
              <button
                ...
                }" :disabled="disabled" type="button" @click="secondButton">
                <div>
                  <Transition name="bounce">
                    <div role="status" class="flex items-center">
                      <svg aria-hidden="true"
                        class="w-4 h-4 animate-spin text-white-600 fill-gray-800 flex items-center" stroke-width="1.5"
            ...
            <div v-if="!disabled || disabledWhichButton !== 'secondButton'">
              <button
                ...
                type="button" @click="secondButton">
                {{ secondButtonText }}
              </button>
            </div>
          </div>
